...
#define STRING_CONFIG_H_AUTHOR "(Larry, BIGTREETECH, Ender-3)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Larry's Ender-3"
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -44.3, -6.6, -2.28 }
